...
def root():
    """Health check"""
    return {"status": "online", "service": "AI Ticketing System", "version": "1.0.0"}


@app.get("/health")
def health():
    """Health check endpoint (for AgentOS compatibility)"""
    return {"status": "healthy", "service": "AI Ticketing System"}
...
def get_ticket(ticket_id: str):
    ...
    return {"ticket": ticket.dict(), "status": status_value}
