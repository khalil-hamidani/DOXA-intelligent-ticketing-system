...
class UnifiedKnowledgeBase:
    ...
    def _init_retriever(self):
        ...
        try:
            ...
            # Use ASCII-safe logging to avoid Windows encoding issues
            import logging

            logging.warning(f"Failed to import retriever: {e}")
        ...
        if not self.initialized:
            ...
            logging.warning(
                f"Knowledge base not initialized at {self.kb_dir}. Please run ingest scripts."
            )
